        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-5 pb-2">
                    <div class=" p-0">
                        <form action="{{route('user_content_update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" value="{{Storage::url($rs->image)}}" class="form-control border border-info px-2" name="image" id="image" placeholder="{{Storage::url($rs->image)}}">
                                @if($rs->image)
                            ...
                            <button type="submit" class="btn btn-info shadow-dark">Kaydet</button>
                        </form>
                    </div>
                </div>
            </div>
