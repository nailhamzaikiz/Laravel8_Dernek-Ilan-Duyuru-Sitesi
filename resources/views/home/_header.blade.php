              ...
              <span class="navbar-toggler-bar bar3"></span>
                    ...
                    <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
                        <ul class="navbar-nav navbar-nav-hover ms-auto">
                            ...
                            <li class="nav-item mx-2 {{ (request()->is('haberler')) ? 'bg-info rounded-3' : '' }}">
                                <a class="nav-link {{ (request()->is('haberler')) ? 'text-white' : '' }}" href="{{route('haberler')}}"><i class="far fa-newspaper opacity-6 me-2 text-md"></i>Haberler</a>
                            </li>
                            <li class="nav-item mx-2 {{ (request()->is('duyurular')) ? 'bg-info rounded-3' : '' }}">
                                <a class="nav-link {{ (request()->is('duyurular')) ? 'text-white' : '' }}" href="{{route('duyurular')}}"><i class="fas fa-bullhorn opacity-6 me-2 text-md"></i>Duyurular</a>
                            </li>
