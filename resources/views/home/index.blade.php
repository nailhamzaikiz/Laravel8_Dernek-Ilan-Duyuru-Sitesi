...
@section('content')
    ...
    <div class="card card-body container col-md-6 offset-md-1 mt-5 border-1 shadow-dark" >
        <!-- İçerik -->
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card card-plain">
                        ...
                        <div class="card-body px-0 ">
                            ...
                            <a href="{{route('content',['id'=>$data->id])}}" class="text-info text-sm icon-move-right">Haber Detayları
