                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0 text-center">
                            ...
                            <tr>
                                ...
                                <th class="text-uppercase text-danger text-xxs font-weight-bolder opacity-7">İçerik</th>
                                <th class="text-uppercase text-danger text-xxs font-weight-bolder opacity-7">Konu</th>
                                <th class="text-uppercase text-danger text-xxs font-weight-bolder opacity-7">Yorum</th>
                                <th class="text-uppercase text-danger text-xxs font-weight-bolder opacity-7">Status</th>
                                <th class="text-uppercase text-danger text-xxs font-weight-bolder opacity-7">Tarih</th>
                                        ...
                                        <td>
                                            <div class=" px-2 py-1 ">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm ">{{ $rs->user->name }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-secondary text-xs font-weight-bold ">{{$rs->content->title}}</td>
                                        <td class="text-secondary text-xs font-weight-bold ">{{$rs->subject}}</td>
                                        <td class="text-secondary text-xs font-weight-bold ">{{$rs->review}}</td>
                                        <td class="text-secondary text-xs font-weight-bold ">{{$rs->status}}</td>
                                        <td class="text-secondary text-xs font-weight-bold ">{{$rs->created_at}}</td>
                                        <td class="text-secondary text-xs font-weight-bold ">
                                            <a href="{{route('admin_review_show',['id'=>$rs->id])}}" onclick="return !window.open(this.href,'','top=50 left=100 width=800 height=700')"><i class="fas fa-edit"></i></a>
                                        </td>
                                        <td class="text-uppercase text-secondary text-xs font-weight-bold ">
                                            <a href="{{route('admin_review_delete', ['id'=>$rs->id])}}" onclick="return confirm('{{$rs->title}} silinecek. Emin misiniz ?')" ><i class="far fa-trash-alt"></i></a>
                                        </td>
