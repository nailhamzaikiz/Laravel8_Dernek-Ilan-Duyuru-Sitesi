                    ...
                    <div class=" p-0">
                        <form action="{{route('admin_faq_update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control border border-info px-2" name="question" id="question" type="text" value="{{$data->question}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1" class="font-weight-bold">Cevap</label>
                                <textarea class="form-control border border-info px-2"  name="answer" id="summernote" >{{$data->answer}}</textarea>
                                <script>
