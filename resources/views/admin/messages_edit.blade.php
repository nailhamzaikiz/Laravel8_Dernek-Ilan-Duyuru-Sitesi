            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    ...
                    <div class="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Mesaj Detayı</h6>
                    </div>
                </div>
                <div class="card-body ">
                    <div class=" p-0">
                            ...
                            <table class="table align-items-center mb-0 ">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-secondary text-xs font-weight-bold ">{{$data->name}}</td>
                                    </tr>
                                    <tr>
                                        <th class="text-dark text-s font-weight-bold ">Email</th>
                                        <td class="text-xs font-weight-bold ">{{$data->email}}</td>
                                    </tr>
                                    <tr>
                                        <th class="text-dark text-s font-weight-bold ">Telefon</th>
                                        <td class="text-xs font-weight-bold ">{{$data->phone}}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th class="text-dark text-s font-weight-bold ">Mesaj</th>
                                        <td class="text-xs font-weight-bold ">{{$data->message}}</td>
                                    </tr>
                                    <tr>
                                        <th class="text-dark text-s font-weight-bolder ">Yönetici Notu</th>
