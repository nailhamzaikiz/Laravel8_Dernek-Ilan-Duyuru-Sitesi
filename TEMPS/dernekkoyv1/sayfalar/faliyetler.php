...
<div class="baslik"><h1>FAALİYETLER</h1></div>
<?php 
$faaliyetSorgu = mysql_query("SELECT * FROM faliyetler WHERE durum = 1 ORDER BY id DESC");
while($faaliyetSonuc = mysql_fetch_object($faaliyetSorgu)){
?>
<div class="kat-kb"><a href="faliyetler-<?php echo $faaliyetSonuc->seo;?>"><img src="wp-content/uploads/faaliyet/<?php echo $faaliyetSonuc->resim;?>" alt="<?php echo $faaliyetSonuc->adi;?>" /><?php echo $faaliyetSonuc->adi;?></a><p><?php echo kisalt($faaliyetSonuc->aciklama,80);?></p></div>
<?php }?>
<div class="tmz"></div>
<div class="sayfalama"><div class='wp-pagenavi'>
