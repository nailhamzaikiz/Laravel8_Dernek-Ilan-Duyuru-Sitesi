<div id="content">
    ...
    <div class="solbar">
        ...
        <?php $faaliyetSorgu=mysql_query( "SELECT * FROM manset WHERE durum = 1 ORDER BY id DESC"); 
		while($faaliyetSonuc=mysql_fetch_object($faaliyetSorgu)){ ?>
        <div class="kat-kb"><a href="haber-<?php echo $faaliyetSonuc->seo;?>"><img src="wp-content/uploads/manset/<?php echo $faaliyetSonuc->resim;?>" alt="<?php echo $faaliyetSonuc->adi;?>" /><?php echo $faaliyetSonuc->adi;?></a>
            <p>
				<?php echo kisalt($faaliyetSonuc->aciklama,90);?>
            </p>
            </div>
        <?php }?>
        <div class="tmz"></div>
