...
<div class="baslik"><h1>VİDEO GALERİ</h1></div>
<?php 
$videoSorgu = mysql_query("SELECT * FROM video WHERE durum = 1 ORDER BY id DESC");
while($videoSonuc = mysql_fetch_object($videoSorgu)){
?>
<div class="kat-k"><a href="video-galeri-<?php echo $videoSonuc->seo;?>"><img src="wp-content/uploads/video/<?php echo $videoSonuc->resim;?>" alt="Ne Dediler? (<?php echo $videoSonuc->adi;?>)" />Ne Dediler? (<?php echo $videoSonuc->adi;?>)</a></div>
<?php } ?>
<div class="tmz"></div>
