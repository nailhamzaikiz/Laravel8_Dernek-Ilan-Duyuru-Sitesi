<div id="content">
    ...
    <div class="solbar">
        ...
        <?php $etkinlikSorgu=mysql_query( "SELECT * FROM etkinlikler WHERE durum = 1 ORDER BY tarih ASC");
		while($etkinlikSonuc=mysql_fetch_object($etkinlikSorgu)){ ?>
        <div class="kat-kb"><a href="etkinlikler-<?php echo $etkinlikSonuc->seo;?>"><img src="wp-content/uploads/etkinlikler/<?php echo $etkinlikSonuc->resim;?>" alt="<?php echo $etkinlikSonuc->adi;?>" /><?php echo $etkinlikSonuc->adi;?></a>
        <p>
            <?php echo kisalt($etkinlikSonuc->aciklama,90);?>
        </p>
            </div>
        <?php }?>
        <div class="tmz"></div>
